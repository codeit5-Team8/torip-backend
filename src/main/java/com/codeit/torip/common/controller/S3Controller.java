...
public class S3Controller {
    ...
    public CommonResponse<S3UrlResponse> generateS3UploadUrl(@RequestBody String fileName) {
    ...
    public CommonResponse<S3UrlResponse> generateS3DownloadUrl(@RequestBody String filePath) {
